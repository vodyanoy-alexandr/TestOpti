...
public class SettingOfficesApiTest {
    ...
    public void deleteOfficeTest() {
        ...
        String requestBody = "{\"id\":\"9a66c660-0df5-4b6d-b64e-c0f85b6e95a8\"}"; // id удаляемого офиса todo вынести в модель или получать id офиса из вне или запроса на создание офиса
